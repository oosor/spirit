            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown dropdown-extend">
                    ...
                    <div class="dropdown-menu dropdown-extend-menu dropdown-menu-dark" role="menu">
                        <div class="row">
                            <div class="col-md-3">
                                <a class="dropdown-item" href="docs/alerts.html"><i class="fa fa-alert-circled"></i> Alerts</a>
                                <a class="dropdown-item" href="docs/animations.html"><i class="fa fa-wand"></i> Animations</a>
                                <a class="dropdown-item" href="docs/badges.html"><i class="fa fa-ios-pricetag-outline"></i> Badges</a>
                                <a class="dropdown-item" href="docs/buttons.html"><i class="fa fa-ios-paperplane"></i> Buttons</a>
                                <a class="dropdown-item" href="docs/button-groups.html"><i class="fa fa-ios-browsers"></i> Button groups</a>
                                <a class="dropdown-item" href="docs/cards.html"><i class="fa fa-ios-albums-outline"></i> Cards</a>
                            </div>
                            <div class="col-md-3">
                                <a class="dropdown-item" href="docs/carousel.html"><i class="fa fa-android-arrow-dropright-circle"></i> Carousel</a>
                                <a class="dropdown-item" href="docs/accordion.html"><i class="fa fa-navicon"></i> Accordion</a>
                                <a class="dropdown-item" href="docs/cta.html"><i class="fa fa-funnel"></i> Call to action</a>
                                <a class="dropdown-item" href="docs/dropdowns.html"><i class="fa fa-arrow-down-b"></i> Dropdowns</a>
                                <a class="dropdown-item" href="docs/forms.html"><i class="fa fa-clipboard"></i> Forms</a>
                                <a class="dropdown-item" href="docs/input-groups.html"><i class="fa fa-toggle"></i> Input groups</a>
                            </div>
                            <div class="col-md-3">
                                <a class="dropdown-item" href="docs/icons.html"><i class="fa fa-social-octocat"></i> Icons</a>
                                <a class="dropdown-item" href="docs/list-groups.html"><i class="fa fa-ios-list-outline"></i> List groups</a>
                                <a class="dropdown-item" href="docs/modals.html"><i class="fa fa-monitor"></i> Modals</a>
                                <a class="dropdown-item" href="docs/navs.html"><i class="fa fa-navigate"></i> Navs</a>
                                <a class="dropdown-item" href="docs/navbars.html"><i class="fa fa-navicon-round"></i> Navbars</a>
                                <a class="dropdown-item" href="docs/plugins.html"><i class="fa fa-compose"></i> New plugins</a>
                            </div>
                            <div class="col-md-3">
                                <a class="dropdown-item" href="docs/progress.html"><i class="fa fa-stats-bars d-inline-block" style="transform: rotate(90deg);"></i> Progress bars</a>
                                <a class="dropdown-item" href="docs/stats-cards.html"><i class="fa fa-arrow-graph-up-right"></i> Stats cards</a>
                                <a class="dropdown-item" href="docs/tables.html"><i class="fa fa-grid"></i> Tables</a>
                                <a class="dropdown-item" href="docs/typography.html"><i class="fa fa-paintbrush"></i> Typography</a>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-dark" role="menu">
                        ...
                        <a class="dropdown-item" href="ecommerce/collectfa fa-grid.html">Products grid</a>
                        <a class="dropdown-item" href="ecommerce/collectfa fa-list.html">Products list</a>
                        <a class="dropdown-item" href="ecommerce/collectfa fa-grid-sidebar.html">Products grid w/ sidebar</a>
                        <a class="dropdown-item" href="ecommerce/collectfa fa-list-sidebar.html">Products list w/ sidebar</a>
